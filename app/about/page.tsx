  ...
  return (
    <>
      <PageHero
        ...
        title="CipherPix"
        description="CipherPix: A Hybrid Image Encryption System Using Caesar Cipher and Rail Fence Algorithms."
      />
      <section className="page-container grid gap-5 pb-12 md:grid-cols-2">
        ...
        <FeatureCard icon={Code2} title="Included technology">
          Next.js, React, TypeScript, Tailwind CSS, Shadcn/UI foundations,
          Zustand, Web Workers, Web Crypto, File APIs, typed arrays, Blob URLs
          and localStorage.
        </FeatureCard>
        <FeatureCard icon={UserRound} title="Developer information">
          <strong>Mike Coffie</strong>
          <br />
          Index Number: 5221040080
          <br />
          Developer and Researcher
        </FeatureCard>
        <FeatureCard icon={Code2} title="Source repository">
          CipherPix is maintained in the public GitHub repository.
          <a
            ...
            rel="noreferrer"
          >
            Masood-zone/cipherpix <ExternalLink className="size-4" />
          </a>
        </FeatureCard>
      </section>
      <section className="page-container grid gap-5 pb-12 md:grid-cols-2">
        ...
        <Notice tone="warning" title="Excluded scope">
          Authentication, databases, cloud storage, mobile-native applications,
          AES/RSA implementation, production security, and external file
          processing.
        </Notice>
      </section>
    </>

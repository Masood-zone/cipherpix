...
export function PageHero({
  ...
  return (
    <section
      className={cn(
        "page-container pt-12 pb-8 sm:pt-16",
  ...
  return (
    <ol className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      {steps.map((step, index) => (
        <li key={step} className="surface-card flex items-start gap-3">
    ...
    <div className="page-container section-space">
      <div className="surface-card mx-auto max-w-xl text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold">
          Temporary result unavailable
        </h1>
        <p className="mt-3 text-muted-foreground">
          The temporary result is no longer available. Repeat the operation.
          CipherPix does not persist file data between page refreshes.
        </p>
        <Link
          className="link-button mt-6"
          href={operation === "encryption" ? "/encrypt" : "/decrypt"}
        >
